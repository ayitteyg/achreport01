...
class Baptism(models.Model):
    ...
    church= models.CharField(max_length=25, choices=CHURCH)
    minutes_number = models.CharField(max_length=100, blank=True, null=True)
    baptized_by = models.CharField(max_length=255)
    place_baptized = models.CharField(max_length=255, blank=True, null=True)
...
class Transfer(models.Model):
    ...
    other_names = models.CharField(max_length=255, blank=True, null=True)
    gender = models.CharField(max_length=1, choices=GENDER_CHOICES)
    date_church_voted = models.DateField(blank=True, null=True)
    minutes_number = models.CharField(max_length=100,blank=True, null=True)
